						...
						<div class="card-body p-4">
							...
							<form action="adminLogin" method="post">
								<div class="form-group">
									<label for="adm_no">관리자 아이디</label>
									<input class="form-control" type="text" id="adminId" name="adminId" placeholder="관리자 아이디를 입력하세요." />
								</div>
								
								<div class="form-group">
									<label for="adm_pw">비밀번호</label> <br /> <input type="password" class="form-control"
										id="adminPw" name="adminPw" placeholder="비밀번호를 입력하세요." />
								</div>
