					...
					<div class="card-body">
						...
						<div class="row" id="medical">
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										<form action="serviceInsert" name="medical" method="post"
											enctype="multipart/form-data">
											<div class="row">
												<div class="col-lg-6">
													<input type="hidden" name="bct_code" value="M" /> <input
												...
												<div class="col-lg-6">
													...
													<div class="form-group mb-3">
														<label for="example-fileinput" style="margin-right: 15px;">사업장
															사진</label> <input type="file" name="bgl_ori" multiple />
													</div>
													<div class="form-group mb-3">
														<label for="simpleinput">제공서비스</label><br /> ${medical}
													</div>
													<div class="form-group mb-3">
														<label for="simpleinput">서비스 가능한 동물종류</label><br />
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox' name='animal_code'
																value='소형견' id='소형견' /> <label
																class='custom-control-label' for='소형견'>소형견</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox' name='animal_code'
																value='중형견' id='중형견' /> <label
																class='custom-control-label' for='중형견'>중형견</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox' name='animal_code'
																value='대형견' id='대형견' /> <label
																class='custom-control-label' for='대형견'>대형견</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox' name='cat_code'
																value='고양이' id='고양이' /> <label
																class='custom-control-label' for='고양이'>고양이</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox' name='animal_code'
																value='소동물' id='소동물' /> <label
																class='custom-control-label' for='소동물'>소동물</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox' name='animal_code'
																value='파충류' id='파충류' /> <label
																class='custom-control-label' for='파충류'>파충류</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox' name='animal_code'
																value='가축' id='가축' /> <label
																class='custom-control-label' for='가축'>가축</label>
														</div>
													</div>
												</div>
												<div class="col-lg-6">
													<div class="form-group mb-3">
														<label for="simpleinput">영업 오픈시간</label> <input
															type="time" class="form-control" name="work_o"
															id="am_open" step="1800">
													</div>
													<div class="form-group mb-3">
						...
						<div class="row" id="beauty">
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										<form action="serviceInsert" name="beauty" method="post"
											enctype="multipart/form-data">
											<div class="row">
												<div class="col-lg-6">
													<input type="hidden" name="bct_code" value="B" /> <input
														type="hidden" name="cnt" value="${cnt}" /> &nbsp;
												</div>
											</div>
											<div class="row">
												<div class="col-lg-6">
													...
													<div class="form-group mb-3">
														...
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox checkbox'
																name='animal_code' value='소형견' id='소형견_b' /> <label
																class='custom-control-label' for='소형견_b'>소형견</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox checkbox'
																name='animal_code' value='중형견' id='중형견_b' /> <label
																class='custom-control-label' for='중형견_b'>중형견</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox checkbox'
																name='animal_code' value='대형견' id='대형견_b' /> <label
																class='custom-control-label' for='대형견_b'>대형견</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox checkbox'
																name='cat_code' value='고양이' id='고양이_b' /> <label
																class='custom-control-label' for='고양이_b'>고양이</label>
														</div>
													</div>
													<div class="form-group mb-3">
														<label for="simpleinput">제공서비스</label><br /> ${beauty}
													</div>
												</div>
												<div class="col-lg-6">
													<div class="form-group mb-3">
													...
													<div class="form-group mb-3">
														...
														<div class='custom-control custom-checkbox'>
															<input type="checkbox" class='custom-control-input'
																name="holiday" value="월요일" id='월요일_b' /> <label
																class='custom-control-label' for='월요일_b'>월요일</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type="checkbox" class='custom-control-input'
																name="holiday" value="화요일" id='화요일_b' /> <label
																class='custom-control-label' for='화요일_b'>화요일</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type="checkbox" class='custom-control-input'
																name="holiday" value="수요일" id='수요일_b' /> <label
																class='custom-control-label' for='수요일_b'>수요일</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type="checkbox" class='custom-control-input'
																name="holiday" value="목요일" id='목요일_b' /> <label
																class='custom-control-label' for='목요일_b'>목요일</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type="checkbox" class='custom-control-input'
																name="holiday" value="금요일" id='금요일_b' /> <label
																class='custom-control-label' for='금요일_b'>금요일</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type="checkbox" class='custom-control-input'
																name="holiday" value="토요일" id='토요일_b' /> <label
																class='custom-control-label' for='토요일_b'>토요일</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type="checkbox" class='custom-control-input'
																name="holiday" value="일요일" id='일요일_b' /> <label
																class='custom-control-label' for='일요일_b'>일요일</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type="checkbox" class='custom-control-input'
																name="holiday" value="공휴일" id='공휴일_b' /> <label
																class='custom-control-label' for='공휴일_b'>공휴일</label>
														</div>
													</div>
												</div>
												<div class="col-lg-12">
													<button type="button" class="btn btn-outline-secondary"
														name="B" onclick="priceBox(this)">가격 등록</button>
													&nbsp; <input type="reset" class="btn btn-outline-danger"
														value="취소" onclick="cancel()" /> <br /> <br />
													<div id="B"></div>
													<!--서비스 가격 찍히는 div-->
													<div id="B_price"></div>
													<!--고양이 서비스 가격 찍히는 div-->
									...
									<div class="card-body">
										<form action="serviceInsert" name="hotel" method="post"	enctype="multipart/form-data">
											<div class="row">
												<div class="col-lg-6">
													...
													<div class="form-group mb-3">
														...
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox checkbox'
																name='animal_code' value='소형견' id='소형견_h' /> <label
																class='custom-control-label' for='소형견_h'>소형견</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox checkbox'
																name='animal_code' value='중형견' id='중형견_h' /> <label
																class='custom-control-label' for='중형견_h'>중형견</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox checkbox'
																name='animal_code' value='대형견' id='대형견_h' /> <label
																class='custom-control-label' for='대형견_h'>대형견</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox checkbox'
																name='cat_code' value='고양이' id='고양이_h' /> <label
																class='custom-control-label' for='고양이_h'>고양이</label>
														</div>
														<div class='custom-control custom-checkbox'>
															<input type='checkbox'
																class='custom-control-input checkbox checkbox'
																name='animal_code' value='소동물' id='소동물_h' /> <label
																class='custom-control-label' for='소동물_h'>소동물</label>
														</div>
													</div>
													<div class="form-group mb-3">
														<label for="simpleinput">제공서비스</label><br /> ${hotel}
													</div>
												</div>
												<div class="col-lg-6">
													<div class="form-group mb-3">
												...
												<div class="col-lg-12">
													<button type="button" class="btn btn-outline-secondary"
														name="H" onclick="priceBox(this)">가격 등록</button>
													&nbsp; <input type="reset" class="btn btn-outline-danger"
														value="취소" onclick="cancel()" /> <br /> <br />
													<div id="H"></div>
													<!--서비스 가격 찍히는 div  -->
